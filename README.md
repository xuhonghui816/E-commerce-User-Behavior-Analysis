...
## 📊 项目亮点
- **核心发现**：通过RFM模型识别出前 0.4% 的客户（冠军+忠实）贡献了约 13% 的收入
- **模型效果**：使用多个模型构建购买预测模型，其中RF模型AUC达到0.725
...
| 客户分群 | 占比 | 价值特征 | 战略定位 |
|---------|------|----------|----------|
| 冠军客户 | 0.1% | 超高价值、高活跃度 | **战略核心** |
| 忠实客户 | 0.3% | 高价值、稳定复购 | **重点维护** |
| 潜力客户 | 57.3% | 中等价值、成长空间 | **价值提升** |
| 一般客户 | 17.4% | 低价值、低活跃度 | **效率优化** |
